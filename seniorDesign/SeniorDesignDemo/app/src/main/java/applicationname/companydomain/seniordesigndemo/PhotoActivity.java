...
import Controllers.PhotoActivityController;
...
public class PhotoActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private static PhotoActivityController mPhotoController;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        foodData = (ListView) findViewById(R.id.list_food);
        foodList = new ArrayList<>();
        feature = new Feature();
        data = new ArrayList<>();
        feature.setType(visionAPI);
        feature.setMaxResults(10);
        mPhotoController = new PhotoActivityController(this, this);
        ...
        foodData.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                String URI = mPhotoController.getURI(position);
                nextScreen(URI);
            }
        });
    }
    ...
    private void callCloudVision(final Bitmap bitmap, final Feature feature) {
        ...
        new AsyncTask<Object, Void, String>() {
            ...
            protected void onPostExecute(String result) {
                ...
                mPhotoController.listFoods(data);
            }
        }.execute();
    }
    ...
    public void showList(final List<String> s, final PhotoActivity p){
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                adapter2 = new ArrayAdapter<String>(p, android.R.layout.simple_expandable_list_item_1, s);
    ...
    public void nextScreen(String URI) {
        Intent loadNutrientScreen = new Intent(this, ShowNutrientsActivity.class);
