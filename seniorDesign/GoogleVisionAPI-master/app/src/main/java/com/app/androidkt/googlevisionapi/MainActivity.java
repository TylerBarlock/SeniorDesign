...
import com.google.api.services.vision.v1.model.ImageAnnotationContext;
...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private String[] visionAPI = new String[]{"LANDMARK_DETECTION", "LOGO_DETECTION", "SAFE_SEARCH_DETECTION", "IMAGE_PROPERTIES", "LABEL_DETECTION", "WEB_DETECTION", "OBJECT_LOCALIZATION"};
    ...
    private String convertResponseToString(BatchAnnotateImagesResponse response) {
        ...
        switch (api) {
            ...
            case "LABEL_DETECTION":
                ...
                message = formatAnnotation(entityAnnotations);
                Log.e(TAG, "convertResponseToString: " + message);
                break;
            case "WEB_DETECTION":
                ...
                {
                    message +=  wbl.get(i).getDescription() + " " + wbl.get(i).getScore() + "\n";
                }

                //message = formatAnnotation(entityAnnotations);
                break;
            case "OBJECT_LOCALIZATION":
                List<com.google.api.services.vision.v1.model.WebLabel> wb1 = imageResponses.getWebDetection().getBestGuessLabels();


                for(int i =0; i<wb1.size(); i++)
                {
                    message +=  wb1.get(i).getLabel() +"\n";
                }
